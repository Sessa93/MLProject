...
\section{Experiments}
  ...
  \subsection{Results}
    \subsubsection{Baseline Classifier}
      ...
      \begin{itemize}
       \item Linear Kernel, Accuracy on the test set: ~ 67\%
       \item Polynomial Kernel(third degree), Accuracy on the test set: ~ 69\% 
       \item Gaussian Kernel, Accuracy on the test set;
      \end{itemize}
      The optimal hyper-parameter are chosen by 5-fold cross-validation.\newline
      The the accuracy over the test 
